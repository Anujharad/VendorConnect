...
import { formatPhoneNumber, generateStarRating, formatDate } from '../../utils/helpers';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                {currentUser && (
                  ...
                  >
                    <Heart size={24} fill={isFavorite(supplier.id) ? 'currentColor' : 'none'} />
                  </button>
                )}
              </div>
              ...
              <div className="flex items-center space-x-3 mb-6">
                <div className="flex items-center space-x-2">
                  <span className="text-yellow-400 text-xl">{generateStarRating(supplier.rating)}</span>
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">{formatPhoneNumber(supplier.phone)}</span>
                  </div>
                  <div className="flex items-center space-x-3">
          ...
          <div className="space-y-6">
            ...
            {/* Stats Card */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Supplier Stats</h3>
