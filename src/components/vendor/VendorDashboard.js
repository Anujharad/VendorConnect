      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your supplier relationships and discover new opportunities
            for your business.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">
            Supplier Loyalty Status
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {suppliers
              .filter((supplier) => supplier.relationship?.loyaltyBadge)
              .map((supplier) => (
                <div
                  key={supplier.id}
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <LoyaltyBadge type={supplier.relationship.loyaltyBadge} />
                  </div>
                  <div className="text-sm text-gray-600">
                    <p>Orders: {supplier.relationship.totalOrders || 0}</p>
                    <p>Spent: ₹{supplier.relationship.totalSpent || 0}</p>
                  </div>
                </div>
              ))}
          </div>
          {suppliers.filter((supplier) => supplier.relationship?.loyaltyBadge)
            .length === 0 && (
            <p className="text-gray-600 text-center py-4">
              No loyalty relationships established yet. Start ordering from
              suppliers to build loyalty status!
            </p>
          )}
        </div>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {recentSuppliers.length > 0 ? (
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2">
                            ...
                            {supplier.relationship?.loyaltyBadge && (
                              <LoyaltyBadge
                                type={supplier.relationship.loyaltyBadge}
                                showDetails
                              />
                            )}
                          </div>
                          ...
                          {supplier.relationship && (
                            <div className="mt-2 text-sm text-gray-600">
                              <p>
                                Total Orders:{" "}
                                {supplier.relationship.totalOrders || 0}
                              </p>
                              <p>
                                Total Spent: ₹
                                {supplier.relationship.totalSpent || 0}
                              </p>
                            </div>
                          )}
                        </div>
                  ...
                  <p className="text-gray-600 text-center py-4">
                    No suppliers found. Start exploring!
                  </p>
                )}
              </div>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  Regular communication with suppliers leads to better deals and
                  service.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  Always read reviews and ratings before choosing new suppliers.
                </p>
              </div>
            </div>
          </div>
